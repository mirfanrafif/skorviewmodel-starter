...
public class ScoreViewModel extends ViewModel {
    private MutableLiveData<ArrayList<GoalScorer>> homeGoalScorerList = new MutableLiveData<ArrayList<GoalScorer>>();
    private MutableLiveData<ArrayList<GoalScorer>> awayGoalScorerList = new MutableLiveData<ArrayList<GoalScorer>>();
